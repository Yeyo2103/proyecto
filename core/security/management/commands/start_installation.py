    ...
    def handle(self, *args, **options):
        ...
        modules_data.extend([
            ...
            },
            {
                ...
                'description': 'Permite administrar las cajas registradoras de la compañia',
                'moduletype': moduletype,
                'permissions': list(Permission.objects.filter(content_type__model=CashRegister._meta.label.split('.')[1].lower()))
            },
            {
                'name': 'Clientes',
                'url': '/pos/client/',
        ...
        user = User.objects.create(
            names='Edwin Cevallos Sarango',
            username='admin',
            email='edacesar21@gmail.com',
            is_active=True,
            is_superuser=True,
            is_staff=True
        )
